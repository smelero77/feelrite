...
import { Plus, User, Phone, MapPin, FileText, Users, ChevronLeft } from "lucide-react"

export default function TabletPatientForm() {
    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Crear nueva ficha de paciente</p>
        </div>
      ...
      {/* Main Content - Single Column for Tablet */}
          ...
          <div className="space-y-6">
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="fecha" type="date" value="2025-01-08" />
                  </div>
                </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <Button variant="outline" onClick={addCustomField} className="flex items-center gap-2">
      ...
      {/* Sidebar for Tablet - Fixed at bottom */}
