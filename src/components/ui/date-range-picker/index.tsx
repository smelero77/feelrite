...
export const DateRangePicker: FC<DateRangePickerProps> & {
  ...
  return (
    ...
    >
      ...
      <PopoverContent align={align} className="w-auto bg-popover border border-border shadow-lg">
        <div className="flex py-2">
          ...
          {!isSmallScreen && (
            <div className="flex flex-col items-end gap-1 pr-2 pl-6 pb-6 border-l border-border">
